...
struct GetGravityRequest_
{
  ...
  _joint_velocities_type joint_velocities;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_torques_type;
  _joint_torques_type joint_torques;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _gravity_type;
